...
- When a phase is not contributing to the pattern its empty contribution is not loaded as separate line in the chart.
...
- Corrected the error message about the log file name format (thanks Mahsa for reporting)
